...
public class MyAssetModificationProcessor : UnityEditor.AssetModificationProcessor
{
	...
	public static void CreateReporter()
	{
		...
		reporter.images.showGraphImage 		= (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Reporter/Images/chart.png", typeof(Texture2D));
	...
	public class BuildInfo
	{
		...
		static void Update ()
		{
			if( !EditorApplication.isCompiling && isCompiling )
			{
				...
				if (ReporterGUI.Events.getBuildInfo != null)
					build_info.Write( ReporterGUI.Events.getBuildInfo() );
				build_info.Close();
			}
